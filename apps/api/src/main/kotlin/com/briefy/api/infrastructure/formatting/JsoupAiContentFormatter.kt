...
class JsoupAiContentFormatter(
    ...
    override fun format(extractedContent: String, provider: String, model: String): String {
        ...
        val systemPrompt = """
            the following is an article, new, blog or similar that has been extracted using jsoup. your job is to:
